...
import project.com.tastore.Konstruktor.Json_Csize;
...
import project.com.tastore.Model.Respon_Csize;
import project.com.tastore.Model.Respon_Cvarian;
import project.com.tastore.Model.Respon_Produk;
import project.com.tastore.R;
import project.com.tastore.User.User_config;
import project.com.tastore.adapter.Adapter_Csize;
import project.com.tastore.adapter.Adapter_Cvarian;
import project.com.tastore.adapter.Adapter_Image;
import project.com.tastore.adapter.Adapter_Image_small;
    ...
    private void simpanPesan(final String jml) {
        ...
        if(tv_var.getText().toString().equals("")){
            ...
            if(fstok<jmlq){
                ...
                dialog.show();
                Model model=db.getRespo().create(Model.class);
                Call<Respon_Produk> call=model.orderBarang(tv_kodev.getText().toString(),tv_ids.getText().toString(),user_info.getId(),skode,barang,hargan,jml,diskon);
