...
import project.com.tastore_laris.Konstruktor.Alamat_tujuan;
import project.com.tastore_laris.Konstruktor.Json_Bank;
...
import project.com.tastore_laris.Model.Respon_Bank;
...
import project.com.tastore_laris.adapter.Adapter_Keranjang;
...
public class Keranjang extends Fragment {
    ...
    private void transaksi() {
        info=User_config.getmInstance(getContext()).getUser();
        Model model=db.getRespo().create(Model.class);
        Call<Respon_Keranjang> call=model.transaksi(info.getId(),tv_total.getText().toString(),alamat_lengkap,kodb,"pesan");
